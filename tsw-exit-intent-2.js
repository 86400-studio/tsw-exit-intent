(function () {
  ...
  console.log('[TSW Exit] script file loaded');
  ...
  function createPopup() {
    ...
    if (!s) {
      ...
      s.textContent =
        ...
        "align-items:center;" +
        "justify-content:center;" +
        "background:radial-gradient(circle at 30% 20%,#fff,rgba(255,255,255,.05));" +
    ...
    console.log('[TSW Exit] popup created');
  ...
  onReady(function () {
    console.log('[TSW Exit] DOM ready – init listeners');
    initDesktop();
    if (isMobile()) {
      initMobile();
    }
